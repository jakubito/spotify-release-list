...
// Followed Artists Manager actions
/** @type {ActionCreatorWithPayload<Artist[], 'setFollowedArtists'>} */
export const setFollowedArtists = createAction('setFollowedArtists')
...
/** @type {ActionCreatorWithPayload<string[], 'unfollowArtists'>} */
export const unfollowArtists = createAction('unfollowArtists')
export const unfollowArtistsStart = createAction('unfollowArtistsStart')
...
/** @type {ActionCreatorWithPayload<string[], 'removeArtistsFromBlocklist'>} */
export const removeArtistsFromBlocklist = createAction('removeArtistsFromBlocklist')